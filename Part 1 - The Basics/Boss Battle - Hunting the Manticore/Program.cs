...
int manticorePosition = GetManticorePosition("Choose a number for the Manticores position. (0 - 100) ", 0, 100);

//player 1 starts here
int GetManticorePosition(string text, int min, int max)
{
    Console.Write(text);
    int number = Convert.ToInt32(Console.ReadLine());

    //check for values outside of the range and ask again
